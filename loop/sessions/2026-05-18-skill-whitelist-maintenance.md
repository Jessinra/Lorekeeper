...
- **"the rest are expected to be skipped, (maybe note somewhere)"** → User delegates the implementation detail of *where* to note it; trusts agent judgment on format. Don't ask "where should I add this?" — just pick the right place.
