...
New MCP tool: `lore_surface(context_hint: str)` — agent passes a brief description of what it's about to do; lorekeeper returns 2–3 memories the agent _didn't explicitly ask for_ but are likely relevant.
