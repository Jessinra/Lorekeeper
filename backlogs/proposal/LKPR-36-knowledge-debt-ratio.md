...
## Problem
Memory fills with noise over time — transient commands, trivial chatter, false starts. There's no signal-to-noise metric, so you can't tell how much of the graph is junk. Decay handles *old* noise but not *low-value* noise.
